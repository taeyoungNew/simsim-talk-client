...
> ブロック機能が投稿・コメント・チャット・フォロー・いいね・通知など、SNS全体で一貫して適用されるよう設計しました。
...
## Phase 2 – User Experience & Safety

### 🔕 通知受信設定

- 通知タイプ別ON/OFF（いいね・コメント・フレンドなど）
- ユーザー単位の通知ミュート機能

---

## Phase 3 – Social Discovery & Search
